...
export const chiefInstructor: Character = {
  ...
  name: '韩金枝',
  title: '总教官',
  sourceImage: assetPath('assets/agents/cards/han-jinzhi-card-v2.webp'),
  image: assetPath('assets/agents/cards/han-jinzhi-card-v2.webp'),
  cropImage: assetPath('assets/agents/crops/han-jinzhi-crop-v2.webp'),
  cardImage: assetPath('assets/agents/cards/han-jinzhi-card-v2.webp'),
